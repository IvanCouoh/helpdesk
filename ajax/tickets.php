                ...
                ?>
                 ...
                 <input type="hidden" value="<?php echo $kind_id;?>" id="kind_id<?php echo $id;?>">
                    ...
                    <tr class="even pointer">
                        ...
                        <a href="#" class='btn btn-default' title='Ver ticket' onclick="obtener_datos('<?php echo $id;?>');" data-toggle="modal" data-target=".bs-example-modal-lg-udp"><i class="glyphicon glyphicon-eye-open"></i></a> 
